...
public enum EnumKnowledge {
    ...
    SIMILAR_QUESTION_STANDARD("测试新增知识标准问题3", "similarQuestionListNormal", "测试新增知识标准答案1"),
    ...
    STANDARD_QUESTION_EXITS("测试新增知识标准问题1", "测试新增知识标准答案"),
    STANDARD_QUESTION_NULL(" ", "测试新增知识标准答案"),
    STANDARD_ANSWER_NULL("测试新增知识标准问题9", " "),
